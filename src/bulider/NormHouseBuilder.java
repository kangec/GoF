...
class NormHouseBuilder extends HouseBuilder {
    ...
    public void addUIComponents() {
        ...
        areaBtn1.addActionListener(new HouseBuilder.AreaListener());
        areaBtn2.addActionListener(new HouseBuilder.AreaListener());
        bedroomBtn1.addActionListener(new HouseBuilder.BedroomListener());
        bedroomBtn2.addActionListener(new HouseBuilder.BedroomListener());
        bathroomBtn1.addActionListener(new HouseBuilder.BathroomListener());
        bathroomBtn2.addActionListener(new HouseBuilder.BathroomListener());
        grageBtn1.addActionListener(new HouseBuilder.GarageListener());
        grageBtn2.addActionListener(new HouseBuilder.GarageListener());

        gardenBtn1.addActionListener(new HouseBuilder.GardenListener());
        gardenBtn2.addActionListener(new HouseBuilder.GardenListener());
    }
