...
public class AirforceGUI extends JFrame implements ItemListener {
    ...
    private final String[] airPlaneName = {"F-15E-Strike-Eagle", "F-16C/D-Fighting-Falcon", "F22A-Rapter",
    ...
    private final String[] AirForceUnit = {"SQUADRON", "GROUP", "WING"};
    private final JComboBox[] optComoBox = new JComboBox[11];
    private final int[] ckBoxStates;
